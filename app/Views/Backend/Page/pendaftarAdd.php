        ...
        <form method="post">
                        ...
                        <div class="form-floating">
                            <select name="status" id="status" class="form-select" required>
                                <?php foreach (getstatus() as $s) : ?>
                                    <option value="<?= $s['num'] ?>" <?= old('status') == $s['num'] ? 'selected' : '' ?>><?= $s['name'] ?></option>
                                <?php endforeach ?>
                            </select>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="mb-3">
                        <div class="form-floating">
                            <textarea class="form-control" placeholder="Leave a comment here" id="alamat" name="alamat" style="height: 100px" required><?= old('alamat') ?></textarea>
                        ...
                        <div class="form-floating">
                            <select class="form-select" aria-label="Default select example" id="jenis_kelas" name="jenis_kelas" required value="<?= old('jenis_kelas') ?>">
                                ...
                                <?php foreach ($jenisKelas as $jk) : ?>
                                    <!-- if old is true selected -->
                                    <option value="<?= $jk->nama ?>" <?= (old('jenis_kelas') == $jk->nama) ? 'selected' : '' ?>><?= $jk->nama ?></option>
                                <?php endforeach; ?>
