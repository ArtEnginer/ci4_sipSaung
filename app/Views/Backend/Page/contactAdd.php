    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-5 col-12 align-self-center">
                <h3 class="text-themecolor mb-0">Data Contact</h3>
                ...
                <form method="post">
                    ...
                    <div class="mb-3">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="jenis" name="jenis" placeholder="Masukan Jenis Lengkap" required value="<?= old('nama') ?>">
