<ul class="app-menu list-unstyled accordion" id="menu-accordion">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?= route_to('jenis-kelas') ?>">
            <!-- class -->
            <span class="nav-icon">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?= route_to('pendaftar') ?>">
            <span class="nav-icon">
    ...
    <!-- settup -->
    <li class="nav-item">
        <a class="nav-link" href="<?= route_to('pengaturan') ?>">
            <span class="nav-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear-fill" viewBox="0 0 16 16">
                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                    <path d="M8 4a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3A.5.5 0 0 1 8 4zm0 6a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-1 0v-1A.5.5 0 0 1 8 10z" />
                </svg>
            </span>
